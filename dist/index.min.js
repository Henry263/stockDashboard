...
//$(document).ready(function() {
    ...
    function getlabelsfornews(_usrkey_labels) {
        ...
        if (isKeyNull) {
            ...
            $.ajax({
                ...
                //url: 'http://localhost:3000/getUsrKey/' + _usrkey_labels,
                complete: function () {
                    //called when complete
                ...
                success: function (res) {
                    ...
                    if (isEmpty(res)) {
                        ...
                        if (isEmpty(res)) {
                            ...
                            var news_counter = 0;
                            getnewsfeed(getLblsArry, news_counter);
                        }
                    }
                    $('.main_btns').removeClass('none-display-class');
                },
    ...
    function validate_userkey() {
        ...
        if (get_local_storage && get_local_storage != "" && get_local_storage != null) {
            ...
            // To check key is there or not. To sync browser with json file.
            $.ajax({
                type: "GET",
                dataType: "json",
                data: '',
                contentType: "application/json; charset=utf-8",
                url: 'https://stok-dashboard.herokuapp.com/getUsrKey/' + get_local_storage,
                //url: 'http://localhost:3000/getUsrKey/' + get_local_storage,
                complete: function () {
                ...
                success: function (res) {
                    ...
                    if (isEmpty(res)) {
                        ...
                        if (isEmpty(res)) {
                            ...
                            // Data set in local storage.
                            localStorage.setObject("stockObject123", res);
                            localStorage.setObject("userUniqKey123", get_local_storage);
