...
$(function () {
    ...
    $("body").on("click", "#get_new_usr_dialog", function () {
        $("#get_usr_keyModal").removeClass("open");
    });

    $("body").on("click", "#start_manual_m", function () {
        $('#start_new_user').trigger('click');
    });
    ...
    function get_user_data(usrky) {
        ...
        $.ajax({
            ...
            error: function () {
                ...
                // Hiding the add stoutton.
                $('#add_new_stock').addClass('none-display-class');
                $('#add_stc_m').addClass('none-display-class');

                // Get user button showing.
                $('#get_my_key').removeClass('none-display-class');
                $('#get_key_m').removeClass('none-display-class');
